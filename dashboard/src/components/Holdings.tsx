        ...
        <table className="w-full border-collapse text-left">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-100">
              <th className="text-[12px] font-normal text-gray-400 p-3.5 pl-5">Instrument</th>
              <th className="text-[12px] font-normal text-gray-400 p-3.5 text-right">Qty.</th>
              <th className="text-[12px] font-normal text-gray-400 p-3.5 text-right">Avg. cost</th>
              <th className="text-[12px] font-normal text-gray-400 p-3.5 text-right">LTP</th>
              <th className="text-[12px] font-normal text-gray-400 p-3.5 text-right">Cur. val</th>
              <th className="text-[12px] font-normal text-gray-400 p-3.5 text-right">P&L</th>
              <th className="text-[12px] font-normal text-gray-400 p-3.5 text-right">Net chg.</th>
              <th className="text-[12px] font-normal text-gray-400 p-3.5 text-right pr-5">Day chg.</th>
            </tr>
          </thead>
          <tbody>
            {holdings.map((h, i) => {
              ...
              return (
                <tr key={i} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="text-[13px] text-gray-600 p-3.5 text-right">{h.qty}</td>
                  <td className="text-[13px] text-gray-600 p-3.5 text-right">{h.avg.toFixed(2)}</td>
                  <td className="text-[13px] text-gray-600 p-3.5 text-right">{h.price.toFixed(2)}</td>
                  <td className="text-[13px] text-gray-600 p-3.5 text-right">{curVal.toFixed(2)}</td>
                  <td className={`text-[13px] font-medium p-3.5 text-right ${isUp ? "text-[#4caf50]" : "text-[#df514c]"}`}>
                    {pnl.toFixed(2)}
                  </td>
                  <td className={`text-[13px] font-medium p-3.5 text-right ${h.net.startsWith("+") ? "text-[#4caf50]" : "text-[#df514c]"}`}>
                    {h.net}
                  </td>
                  <td className={`text-[13px] font-medium p-3.5 text-right pr-5 ${h.day.startsWith("+") ? "text-[#4caf50]" : "text-[#df514c]"}`}>
                    {h.day}
                  </td>
                </tr>
              );
